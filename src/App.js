...
const SendSmsPage = React.lazy(() => import('./screen/admin_screen/Dashboard/SendSmsPage'))
    ...
    <div className="App">
      <Suspense fallback={<FallBackComponent />}>
        <Routes>
          ...
          <Route path='/send-sms' element={adminToken ? <SendSmsPage status={true} /> : <AdminLogin />} />
